        ...
        a.each(g.data, function (h, j) {
          ...
          if (j.type === 'folder') {
            ...
            if (j.type === 'item') {
              ...
              i.data(j);
              if ('additionalParameters' in j && 'itemSelected' in j.additionalParameters && j.additionalParameters['itemSelected'] == true) {
                i.addClass('tree-selected');
                i.find('i').removeClass(e.options['unselected-icon']).addClass(e.options['selected-icon'])
              } else if ('additionalParameters' in j && 'itemSelected' in j.additionalParameters && j.additionalParameters['itemSelected'] == false) { /**/
                i.find('i').removeClass(e.options['selected-icon']).addClass(e.options['unselected-icon'])
              }
            }
          }
