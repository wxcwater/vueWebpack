...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: '共 {0}条数据',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">已筛选</span> {0} 到 {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: '共0条数据',                                                        // when there are no options present in the list
