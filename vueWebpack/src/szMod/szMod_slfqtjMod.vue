...
<script>
import sgnqtjtable from './szMod_slfq_sgnqtjTableContent.vue'
import pwktjtable from './szMod_slfq_pwktjTableContent.vue'
import sydtjtable from './szMod_slfq_sydtjTableContent.vue'
export default {
  name: 'sznormaltjMod',
  props: ['echarts'],
  components: {
