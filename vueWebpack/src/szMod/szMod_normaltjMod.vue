...
<script>
import sgnqtjtable from './szMod_sgnqtjTableContent.vue'
import pwktjtable from './szMod_pwktjTableContent.vue'
import sydtjtable from './szMod_sydtjTableContent.vue'
export default {
  name: 'sznormaltjMod',
  props: ['echarts'],
  components: {
