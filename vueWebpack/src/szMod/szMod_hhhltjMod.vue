...
<script>
import sgnqtjtable from './szMod_hhhl_sgnqtjTableContent.vue'
import pwktjtable from './szMod_hhhl_pwktjTableContent.vue'
import sydtjtable from './szMod_hhhl_sydtjTableContent.vue'
export default {
  name: 'sznormaltjMod',
  props: ['echarts'],
  components: {
